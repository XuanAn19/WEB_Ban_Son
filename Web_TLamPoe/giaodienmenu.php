    ...
    <div id="wrapper">
        <header>
	         <nav class="container">
                ...
                <ul id="main-menu">
                    <li><a href="http://localhost/Web_TLamPoe/index1.php"> Black Rouge</a></li>
                    <li><a href="http://localhost/Web_TLamPoe/index1.php"> 3ce</a></li>
                    <li><a href="http://localhost/Web_TLamPoe/index1.php"> Gucci</a></li>
                    <li><a href="http://localhost/Web_TLamPoe/index1.php"> Dior</a></li>
                    <li><a href="http://localhost/Web_TLamPoe/index1.php"> Srum</a></li>
                </ul>
                </div>
                <div class="main-menu-right">
                <ul id="main-menu-right2">
					<li><a href="http://localhost/Web_TLamPoe/admin1/index.php">Admin</a></li>
					<li><a href="http://localhost/Web_TLamPoe/index1.php">Đăng Nhập</a></li>
                </ul>
                </div>
             </nav>
        </header>
        <menu>
            <div id="formList">
                <div id="list">
                    <div class="item">
                        <img src="./images/anh1.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh2.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh3.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh4.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh5.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh6.webp"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh8.png"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anhh9.jpg"  class="avatar" alt=""> 
                    </div>
                </div>
            </div>
            <div class="direction">
