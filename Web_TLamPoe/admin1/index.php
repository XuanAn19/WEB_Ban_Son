...
<html>
   <head>
    ...
    <link rel="stylesheet" href="css/logindnweb.css">
	...
	<?php
		...
		if($row= mysqli_fetch_array($result)){
			$_SESSION['username']=$row['Username'];
                ...
                $userPrivileges = mysqli_query($kn, "SELECT * FROM `phanquyen_user` INNER JOIN `phan_quyen` ON phanquyen_user.phanquyen_id = phan_quyen.id WHERE phanquyen_user.user_id = ".$row['id']);
                $userPrivileges = mysqli_fetch_all($userPrivileges, MYSQLI_ASSOC);
                if(!empty($userPrivileges)){
                    $row['privileges'] = array();
                    foreach($userPrivileges as $privilege){
                        $row['privileges'][] = $privilege['url'];
                    }
                }
                $_SESSION['username'] = $row;
				//header("location:Tin.php");
      ...
      <div class="login-card-container">
        <div class="login-card">
            ...
            <div class="login-card-header">
                <div><h3>ĐĂNG NHẬP TÀI KHOẢN ADMIN</h3>
            ...
            <div class="login-card-form" >
                ...
                <div class="form-item-other">
                    ...
                    <a href="http://localhost/Web_TLam/admin1/DoiMatKhau_admin.php">Forgot password</a>
                </div>
